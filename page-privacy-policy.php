...
get_header(null,['title'=>'Privacy Policy']);
?>
<div id="sdPolicies">
        ...
        <div class="row">
            <div class="col-12">
                <ol>
                    ...
                    <li><strong>Security Precautions</strong><br>
                    ...
                    <li><strong>Data Deletion and Retention</strong><br>
                    ...
                    <li><strong>Grievance Officer</strong><br>
                        <ul>
                            <li>Vassudeo Shetye</li>
                            <li>CTO</li>
                            <li>Bicholim, Goa, 403529</li>
                            <li>Contact us: vassudeo.shetye@binarydharma.online</li>
                            <li>Time: Monday - Friday (9:00 - 18:00)</li>
                        </ul>
                    </li>
                </ol>
            </div>

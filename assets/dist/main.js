...
.currencyFont, #nbBasketPage #nbInfoArea td {
  color: #384c2c;
  font-weight: 800;
  font-size: 18px; }
  .currencyFont small, #nbBasketPage #nbInfoArea td small {
    font-weight: 500; }
  .currencyFont::before, #nbBasketPage #nbInfoArea td::before {
    content: '₹'; }
...
#nbBasketPage {
  ...
  #nbBasketPage .cartItem {
    ...
    padding: 10px;
    border-radius: 5px; }
    #nbBasketPage .cartItem:hover {
      background-color: #f0f0f0; }
    #nbBasketPage .cartItem img {
      width: 20% !important; }
    #nbBasketPage .cartItem h5 {
      font-weight: 800; }
    #nbBasketPage .cartItem button {
      line-height: 10px;
      border-width: 3px;
      height: 35px;
      width: 35px;
      ...
      margin-top: 0 !important;
      border-width: 0; }
      #nbBasketPage .cartItem button:nth-of-type(1) {
        border-radius: 4px 4px 0 0;
        border-bottom-width: 1.5px;
        border-color: #384c2c; }
      #nbBasketPage .cartItem button:nth-of-type(2) {
        border-radius: 0 0 4px 4px;
        border-top-width: 1.5px;
        border-color: #384c2c; }

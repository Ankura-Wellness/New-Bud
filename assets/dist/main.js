...
.heroFont, .btn-custom, #sdPolicies h1, #nbFooterArea h4, #nbFrontPage #nbAboutUs:first-letter, #nbFrontPage #box > div h3, #nbFrontPage #nbProductsIntro h2, #nbFrontPage #nbProductsIntro h5, #nbFrontPage #nbProductsIntro p:first-letter, #nbFrontPage #nbProductsIntro #nbFeatures h6, #nbPageOurStory p#nbFirstParagraph::first-letter, #nbPageOurStory #nbFoundersNote h2, #nbOurMotivePartial p::first-letter, #nbSingleProduct .nbBreadcrumb a, #nbSingleProduct .nbBreadcrumb span, #bnCheckoutThankYou #nbInfoArea .col-md-3 span {
  font-family: "Amatic SC", sans-serif !important;
  font-weight: 700; }

.primaryFont, a, h3, h4, h5, h6, p, .nbHeader p, .nbPrice .badge, #sdPolicies li, #nbCart #nbCartItemArea .cartItem div h5, #nbCartArea #nbCart #nonEmptyCart h3 .warningMessage, #nbCartArea #nbCart #nbCartItemArea .cartItem div h5, #nbCartArea #nbCart #nbCartItemArea .cartItem div h6, #nbFrontPage #box > div p, #nbFrontPage #nbProductsIntro h3, #nbFrontPage #nbProductsIntro #nbFeatures li, #nbPageOurStory p#nbFirstParagraph, #nbPageOurStory #nbFoundersNote p, .nbSampleProduct a h4, #nbSingleProduct .nbSharing a, #bnCheckoutThankYou th, #bnCheckoutThankYou td {
